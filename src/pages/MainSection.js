...
import { AnimatedName, AnimatedButton, TransitionElement, SectionContainer } from '../components/AnimatedElements';
...
const MainSection = ({ onNavigate }) => {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center transition-colors duration-300">
      ...
      <SectionContainer className="relative z-10 text-center px-4 scale-75 md:scale-100 transform-gpu">
